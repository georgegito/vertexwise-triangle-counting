...
*/
bool check_edge(uint32_t a, uint32_t b, uint32_t row_ptr[], uint32_t col_idx[]){
...
int main(int argc, char** argv){
    ...
    cout << endl << "Workers: " << omp_get_max_threads() << endl << "Graph: " << graph << "\nParallel operation time (OpenMP): " << time_span.count() << " seconds\n";
    printf("Triangles: %u\n\n", triangles);
